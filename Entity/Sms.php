...
class Sms extends FormEntity
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('sms_amazon_messages')
            ->setCustomRepositoryClass('Mautic\MauticSmsAmazonBundle\Entity\SmsRepository');
        ...
        $builder->createManyToMany('lists', 'Mautic\LeadBundle\Entity\LeadList')
            ->setJoinTable('sms_amazon_message_list_xref')
            ->setIndexBy('id')
    ...
    {
        $metadata->setGroupPrefix('sms_amazon')
            ->addListProperties(
                [
                    'id',
                    'name',
