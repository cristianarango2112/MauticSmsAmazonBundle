...
class SmsRepository extends CommonRepository
{
    ...
    public function getEntities($args = [])
    {
        $q = $this->_em
            ...
            ->from('MauticSmsAmazonBundle:Sms', $this->getTableAlias(), $this->getTableAlias().'.id');
    ...
    public function getSentCount()
    {
        ...
        $q->select('SUM(e.sentCount) as sent_count')
            ->from('MauticSmsAmazonBundle:Sms', 'e');
    ...
    public function upCount($id, $type = 'sent', $increaseBy = 1)
    {
        try {
            ...
            $q->update(MAUTIC_TABLE_PREFIX.'sms_amazon_messages')
