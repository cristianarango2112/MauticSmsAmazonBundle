...
<dl class="dl-horizontal">
    <dt><?php echo $view['translator']->trans('mautic.smsamazon.timeline.status'); ?></dt>
    <dd><?php echo $view['translator']->trans($data['status']); ?></dd>
    <dt><?php echo $view['translator']->trans('mautic.smsamazon.timeline.type'); ?></dt>
    <dd><?php echo $view['translator']->trans($data['type']); ?></dd>
</dl>
<div class="small">
    <hr />
    <strong><?php echo $view['translator']->trans('mautic.smsamazon.timeline.content.heading') ?></strong>
    <br />
