...
namespace Mautic\MauticSmsAmazonBundle;

/**
 * Class SmsEvents
 * Events available for SmsBundle.
 */
final class SmsAmazonEvents
{
    /**
     ...
     * @var string
     */
    const TOKEN_REPLACEMENT = 'mautic.sms_amazon_token_replacement';
     ...
     * @var string
     */
    const SMS_ON_SEND = 'mautic.sms_amazon_on_send';
     ...
     * @var string
     */
    const SMS_PRE_SAVE = 'mautic.sms_amazon_pre_save';
     ...
     * @var string
     */
    const SMS_POST_SAVE = 'mautic.sms_amazon_post_save';
     ...
     * @var string
     */
    const SMS_PRE_DELETE = 'mautic.sms_amazon_pre_delete';
     ...
     * @var string
     */
    const SMS_POST_DELETE = 'mautic.sms_amazon_post_delete';
     ...
     * @var string
     */
    const ON_CAMPAIGN_TRIGGER_ACTION = 'mautic.sms_amazon.on_campaign_trigger_action';
}
