...
class Stat
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->setTable('sms_Amazon_message_stats')
            ->setCustomRepositoryClass('Mautic\MauticSmsAmazonBundle\Entity\StatRepository')
    ...
    {
        $metadata->setGroupPrefix('stat_amazon')
            ->addProperties(
                [
                    'id',
                    'ipAddress',
